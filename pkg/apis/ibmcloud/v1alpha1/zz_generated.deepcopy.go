...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EsURISource) DeepCopyInto(out *EsURISource) {
	*out = *in
	in.ValueFrom.DeepCopyInto(&out.ValueFrom)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EsURISource.
func (in *EsURISource) DeepCopy() *EsURISource {
	if in == nil {
		return nil
	}
	out := new(EsURISource)
